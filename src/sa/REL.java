...
public class REL {
	...
	public void testlogin() throws Exception {
		...
		driver.findElement(By.id("password")).sendKeys("cn123456");// 输入登录密码
		Thread.sleep(2000);
	...
	public void neworder2() throws InterruptedException{
	    ...
	    driver.findElement(By.id("customerName")).sendKeys("李看");//修改数据--用户姓
	    driver.findElement(By.id("cardId")).clear();
	    driver.findElement(By.id("cardId")).sendKeys("13020219990101165x");//修改数据--身份证号
	    driver.findElement(By.id("mobile")).clear();
	    driver.findElement(By.id("mobile")).sendKeys("18818824580");//修改数据--电话号码
	    ...
	    driver.findElement(By.id("repaymentAcc")).sendKeys("44321975372555500");//修改数据--银行账号
	  Thread.sleep(2000);
	...
	public void neworder4() throws InterruptedException{
	  ...
	  Thread.sleep(2000);
	    ...
	    driver.findElement(By.id("emaill")).sendKeys("5556128@qq.com");//修改郵箱
	    driver.findElement(By.name("qqCode")).clear();
	    driver.findElement(By.name("qqCode")).sendKeys("52283995");//修改QQ号码
	  ...
	  Thread.sleep(1000);
	   ...
	   // new Select(driver.findElement(By.id("liveProv"))).selectByVisibleText("江苏省");
	    new Select(driver.findElement(By.id("liveProv"))).selectByIndex(0);

	  Thread.sleep(1000);
	    //new Select(driver.findElement(By.id("liveCity"))).selectByVisibleText("苏州市");
	  new Select(driver.findElement(By.id("liveCity"))).selectByIndex(0);
	  Thread.sleep(1000);
	    //new Select(driver.findElement(By.id("liveTown"))).selectByVisibleText("平江区");
	    new Select(driver.findElement(By.id("liveTown"))).selectByIndex(0);
	  ...
	  Thread.sleep(2000);
	    ...
	    driver.findElement(By.name("contractInfos[0].contractPhone")).sendKeys("18912545525");//修改家庭联系人号码
	  ...
	  Thread.sleep(2000);
	    ...
	    driver.findElement(By.name("contractInfos[1].contractPhone")).sendKeys("189223974456");//修改非家庭联系人号码
	  ...
	  Thread.sleep(2000);
	   driver.findElement(By.id("userEvaluateCode")).sendKeys("cn123456");//根据个人登录密码填写
