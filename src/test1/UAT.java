...
public class UAT {
	...
	public void neworder2() throws InterruptedException{
	    ...
	    driver.findElement(By.id("cardId")).sendKeys("310101199301018956");//修改数据--身份证号
	    driver.findElement(By.id("mobile")).clear();
	    driver.findElement(By.id("mobile")).sendKeys("18139953385");//修改数据--电话号码
	    ...
	    driver.findElement(By.id("repaymentAcc")).sendKeys("4432955692423455");//修改数据--银行账号
	    Thread.sleep(2000);
	...
	public void neworder4() throws InterruptedException{
	    ...
	    driver.findElement(By.id("emaill")).sendKeys("53229285338@qq.com");//修改郵箱
	    driver.findElement(By.name("qqCode")).clear();
	    driver.findElement(By.name("qqCode")).sendKeys("56135219395");//修改QQ号码
	    ...
	    driver.findElement(By.name("contractInfos[0].contractPhone")).sendKeys("13359213545");//修改家庭联系人号码
	    ...
	    driver.findElement(By.name("contractInfos[1].contractPhone")).sendKeys("18919534456");//修改非家庭联系人号码
